...
<script>
    ...
    for(let i=0; i<sp.length; i++) {
        if(navigator.userAgent.toLowerCase().match(sp[i])) {
            location.replace("<c:url value='/m.login'/>")
        }
    }
    </script>
<body>
    ...
    <div class="content">
        <div class="content_box">
            ...
            <form action="<c:url value="/login"/>" method="post" onsubmit="return formCheck(this);">
                ...
                <div class="chk_box">
                    <label><input type="checkbox" name="rememberId" ${empty cookie.id.value?"":"checked" }><span>아이디 저장 <img src="../img/crowcanyon/login/img.gif" alt="">보안접속</span></label>
                ...
                <a href="/register/join" class="login_box box4">JOIN US</a>
