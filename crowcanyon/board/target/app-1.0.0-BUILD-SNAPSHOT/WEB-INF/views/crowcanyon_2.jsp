...
<head>
    ...
    <link rel="stylesheet" href="../css/crowcanyon_2.css">
    <link rel="stylesheet" href="../css/hf.css">
    <script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
    <script src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>
    <script defer src="../js/crowcanyon_2.js"></script>
...
<script>
    ...
    for(let i = 0; i < sp.length; i++) {
        if(navigator.userAgent.toLowerCase().match(sp[i])) {
            ...
            let url_cateNo = urlSearch.get('list_cateno');

            let newUrl = '/m.list?list_cateno=' + encodeURIComponent(url_cateNo);
...
<body>
    ...
    <div class="contents content_area1300">
        <h2></h2>
        <div class="item_contents">
            <ul class="item_ul">
                <c:forEach var="ListDto" items="${list}">
                    <li class="item_li">
                        <div class="img_box">
                            <a href="/list/detail?list_seqno=${ListDto.list_seqno}">
                        ...
                        <div class="text_box">
                            <a href="/list/detail?list_seqno=${ListDto.list_seqno}">
                                <div class="name">${ListDto.list_name}</div>
                            </a>
                            <div class="s_price">회원가 : ￦${ListDto.list_s_price}</div>
